...
public class LogInfo extends AsyncTask<String, Void, JSONObject>{
	...
	private static String logInfoURL = "";
	...
	public LogInfo() {
		logInfoURL = "http://sit-edu4.sit.kmutt.ac.th/csc498/53270327/Boss/sftrip/index.php/logInfo";
	...
	protected JSONObject doInBackground(String...strings) {
		...
		params.add(new BasicNameValuePair("latitude", strings[1].toString()));
		params.add(new BasicNameValuePair("longtitude", strings[2].toString()));

		DefaultHttpClient httpClient = new DefaultHttpClient();
		HttpPost httpPost = new HttpPost(logInfoURL);
		// Making HTTP request
		try {
			// defaultHttpClient
